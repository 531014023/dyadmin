...
namespace Org\Wxpay;
    ...
    class Wxpay{
        private $appid = 'wxbc435891c496fd83';//微信平台的appid
        private $mch_id = '1459028502';//商户号
        private $app_key = 'b772a8aae287bfdd69a3c259e34548b4';//商户密钥
        private $sign='';//签名
        private $notify_url = 'https://wy.zetaluoxin.cn/home/wxpay/notify';//回调地址
        ...
        {
            $this->app_id = $param['app_id'] || 'wxbc435891c496fd83';
            $this->mch_id = $param['mch_id'] || '1459028502';
            $this->app_key = $param['app_key'] || 'b772a8aae287bfdd69a3c259e34548b4';
            $this->notify_url = $param['notify_url'] || 'https://wy.zetaluoxin.cn/home/wxpay/notify';
        }
        ...
        public function queryOrder($out_trade_no) {
            ...
            $result = $this->postXmlCurl($xml_data,$this->queryUrl);
            $resultArr = $this->xmlToArray($result);
