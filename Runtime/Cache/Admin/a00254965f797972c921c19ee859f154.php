...
<div class="main-container" id="main-container">
    ...
    <div class="sidebar" id="sidebar">
        ...
        <ul class="nav nav-list">
            <li class="active">
                <a href="javascript:iframe(this,'index')">
                    <i class="icon-home"></i>
            ...
            <li class="">
                ...
                <ul class="submenu">
                    ...
                    <li class="">
                        <a href="javascript:iframe(this,'userlist')">
                            <i class="icon-double-angle-right"></i>
                            用户列表
                        </a>
                    </li>
                    <li class="">
                        <a href="javascript:iframe(this,'stoptrad')">
                            <i class="icon-double-angle-right"></i>
                            禁止交易
                        </a>
                    </li>
                    <li class="">
                        <a href="javascript:iframe(this,'tradinfo')">
                            <i class="icon-double-angle-right"></i>
                            交易明细
                        </a>
                    </li>
    ...
    <div class="main-content">
        ...
        <iframe src="https://www.baidu.com" frameborder="0" id="iframe"></iframe>
    </div>
</div>
...
<script type="text/javascript">
    window.onload = function(){
        ...
        $("#iframe").height(windowH-navH);
        elem();
    }
</script>
<script>
    function iframe(obj,str) {
        switch (str){
            case 'index':
    ...
    function elem() {
        $(".nav-list li").click(function () {
           var ul = $(this).find(".dropdown-toggle");
            if(!ul[0]){
